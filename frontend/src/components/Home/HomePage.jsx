...
import backgroundimg from "../../assets/Background img.png"; // add this at the top of your file

const HeroSection = () => {
  return (
    <>
      <div className="bg-[#01af99] w-full">
        {/* Top image section */}
        <div
          className="w-full bg-no-repeat bg-center bg-contain h-[400px]"
          style={{
        ...
        {/* Content section */}
        <div className="text-white text-center px-4 py-12 max-w-2xl mx-auto">
          <h1 className="text-5xl font-bold mb-6">Spend smarter. Save more.</h1>

          <Link to="/register">
            <button className="px-6 py-3 bg-white text-[#00B495] font-semibold rounded-lg shadow-lg hover:bg-gray-100 transition duration-300">
              Get Started
            </button>
          </Link>
